 ...
 * Reemplaza el `replayReveals()` imperativo del sitio original.
 */
...
export class RevealOnScroll {
  ...
  private readonly stepMs = 55; // separación entre elementos de un mismo grupo
  private readonly maxDelayMs = 320; // tope del stagger por grupo
