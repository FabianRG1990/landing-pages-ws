 ...
 *
 * Sustituye al `useFadeSection` + `.fade-in.visible` del index.html original.
 */
...
export class RevealOnScroll {
  ...
  private readonly stepMs = 70; // separación entre elementos de un mismo grupo
  private readonly maxDelayMs = 350; // tope del stagger por grupo
